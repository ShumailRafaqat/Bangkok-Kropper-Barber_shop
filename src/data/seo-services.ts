...
export const seoServices: SeoService[] = [
  ...
  },
  {
    ...
    shortName: "Women's cut",
    price: 690,
    minutes: 60,
    description:
      "A personalised women's haircut shaped around your texture, routine and everyday style.",
    details:
      "Your barber will refine the shape, movement and finish around your natural hair texture and preferred styling routine.",
    includes: ["Style consultation", "Precision haircut", "Shape and finish", "Styling advice"],
    image: "/2.PNG",
  },
  {
    slug: "kids-haircut",
    ...
    details:
      "A calm service designed around comfort, clear communication and a carefully shaped finish for children.",
    includes: ["Comfort consultation", "Careful haircut", "Neat finish", "Styling advice"],
    image: "/4.png",
  },
];
