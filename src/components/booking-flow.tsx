      ...
      <div key={step} className="animate-rise mt-5">
                    ...
                    <span className="block text-[0.6rem] font-bold uppercase tracking-[0.2em] opacity-80">
                      {i === 0
                        ? language === "th"
                          ? "วันนี้"
                          : "Today"
                        : d.toLocaleDateString(language === "th" ? "th-TH" : "en-US", {
                            weekday: "short",
                          })}
                    </span>
        ...
        {step === 2 && (
          <>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {date ? prettyDate(date, language) : ""} · {t.chairTime} {service?.minutes}{" "}
              {t.minutesShort}
            </p>
                ...
                {(() => {
                  const summaryRows: Array<[typeof Scissors, string, string]> = [
                    ...
                    [
                      ...
                      isLineChannel ? "LINE ID" : channelLabel(currentChannel),
                      isLineChannel ? lineId.trim() : phone.trim(),
                    ],
                  ];
                  if (note.trim()) {
                    summaryRows.push([
            ...
            >
              {sending ? (
                <>
                  ...
                  {channelLabel(contactMethod ?? "whatsapp")}…
                </>
              ) : (
                <>
                  {isLineChannel ? (
                  ...
                  Confirm via {channelLabel(currentChannel)}
                </>
              )}
            </button>
            <p className="mt-3 text-center text-xs text-muted-foreground">
              This prepares your appointment in {channelLabel(contactMethod ?? "whatsapp")}; press
              Send to confirm.
            </p>
          </>
        )}
